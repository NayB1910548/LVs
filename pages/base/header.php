...
<header class="header">
    <div class="header__topbar">
        ...
        <p class="h5">Chào mừng <?php echo $account_name; ?> đến với chúng tôi</p>
            ...
            <div class="header__container d-grid middle-left">
                ...
                <div class="header__logo d-flex justify-center align-center">
                    <a href="index.php" class="d-inline-block">
                        <img class="d-block w-100 svg__icon" src="./assets/images/logo/ruok.png" alt="Logo" style="width: 80px; height: 50px;">
                    </a>
                </div>
